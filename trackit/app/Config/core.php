...
{
	$maintainance_page = SITE_NAME . 'loneman.html';
	die(header("Location: {$maintainance_page}")); 
}
...
Configure::write('GET_PROD_DETAIL', 'get_prod_detail');
Configure::write('CLASSIFY_PAGE', 'classify_page');
Configure::write('GEN_PRICE_NOTF', 'gen_pr_notf');


//postmark stuff
//Configure::write('Postmark.uri', 'http://api.postmarkapp.com/email');
//Configure::write('Postmark.key', 'fb5a207f-b901-40e3-b007-13286087f7ac');
// in email.php config

class SOCIAL_PLATS 
{
	public static $enabled_plats = array ( 
			'static' => array('fb' => 1, 'tw' => 1, 'blog'=>0, 'reddit'=>0, 'imgur' => 0),
			'dynamic' => array('fb' => 1, 'tw' => 1, 'blog'=>0, 'reddit'=>0, 'imgur' => 0, 'signup' => 1,'review'=>1, 'giveaway'=>1)
		);
};

class COUPON_TYPE_NAMES
{
	public static $coupon_types = array ( 
			'percent_off' => '% Off', 'dollar_off' => '$ Off', 'sale' => 'Sale'
		);
};
...
class CUR_CODES 
{
	public static $currencies = array ( 
			'usd' => 'USD', 'eur' => 'EUR', 'inr' => 'INR', 'cad' => 'CAD', 'aud' => 'AUD', 'brl' => 'BRL',
			'love'=>'Love','tyou'=>'Thank You','heart'=>'Heart'
		);
};
