		...
		if ($this->request->is('post')) 
		{
			...
			else
			{
				...
				else
				{
					...
					$campaign_add_url = SITE_NAME . "open_campaigns/add";
					$result['success'] = 1;
					$result['msg'] = "Thank you for registering with us. If you have any questions about how to use this new marketing weapon, feel free to drop us an email or call anytime. <a style='color:white;' href=\"{$campaign_add_url}\"> Proceed to create your first campaign.</a>";
