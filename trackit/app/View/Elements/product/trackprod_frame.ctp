...
function _call_trackit1234567890_part1( $this ){
	var $p = [];
	$p['script'] = 'tracker/trackprod';
	$p['call_to_load'] = 'trackit1234567890_part1';
	$p['scn'] = 'trackit1234567890_part1';
	$p['scp'] = $this;
	$p['ecn'] = 's_s_m';
	$p['ecp'] = "A network error occured.";
	
	script_load_and_call($p);
}
function _call_trackit1234567890_part2( $this ){
	var $p = [];
	$p['script'] = 'tracker/trackprod';
	$p['call_to_load'] = 'trackit1234567890_part2';
	$p['scn'] = 'trackit1234567890_part2';
	$p['scp'] = $this;
	$p['ecn'] = 's_s_m';
	$p['ecp'] = "A network error occured.";
...
<div id="trackit1234567890A" style="padding-top:50px;padding-bottom:50px;">

<?php
if ($show_close_button){
	echo "<div onclick=\"$(this).closest('#trackit1234567890A').parent().css('display','none');\" class='_trackit_popup_x'>X</div>";
}
?>

<form id='form1' style='width:650px;display:none;'>
...
if ($user_logged_in){
echo "
	<track_this_item_button onclick='_call_trackit1234567890_part1( $(this) );'>Track this item</track_this_item_button>
	";	
}else{
echo "
...
<label for='trackit1234567890title' style='display:none;font-size:14px;'>what would you call this item ?</label>
<input id='trackit1234567890title' name='trackit1234567890title' type='hidden' class='trackit1234567890title' style='float:left;'></input>
...
<div style='clear:both'></div>
<label for='trackit1234567890email' style='display:none;float:left; font-size:14px; font-weight:500;'>email </label>
<input type='hidden' id='trackit1234567890email' maxlength='400' name='trackit1234567890email' class='trackit1234567890email' style='width:300; float:left;'></input>
<br/>
<br/>
...
echo "<track_this_item_button onclick='show_ulf();'>SignIn to track this item</track_this_item_button>";
}
?>
</form>
