...
App::uses('AppHelper', 'View/Helper');
    ...
    class YoutubeHelper extends HtmlHelper { 
		...
		// Outputs Youtube video image 
        function get_thumbnail_src($url, $size = 'thumb', $options = array()) { 
		...
		// returns a formatted Youtube video url, combines the given url with given settings 
        function formatVideoUrl($url, $settings = array(), $variables = array()) 
		{ 
            ...
            $src = sprintf($this->apis['player'], $video_id, http_build_query($settings)); 
