	...
	function initMyBookmarklet() {
		(window.myBookmarklet = function() {
		 ...
		 chrome.tabs.query({'active': true, 'lastFocusedWindow': true}, function (tabs) {
			...
			var encoded_title = encodeURIComponent(encodeURIComponent(title));
			var $collecturi = "http://alpha.couponistalking.com/socials/collectlet/?u="+encodeURIComponent(url)+"&t="+encoded_title;
