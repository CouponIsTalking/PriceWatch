...
class ProductListingPage:
    ...
    def isShareItem(self, div):
        ...
        sharewords = ['fblike', 'twitter', 'share', 'email', 'pinterest', 'instagram', 'pinit', 'facebook']
...
#		
    ...
    def getOuterElementOfProduct(self, product_div):
        ...
        if not product_div_text:
            product_div_text = ""
        product_div_text = clean_text(product_div_text)
        ...
        while True:
            ...
            if (div_width > 1.5*product_div_width):
                ...
                if not webele_text:
                    webele_text = ""
                webele_text = clean_text(webele_text)
    ...
    def clean_distracting_divs(self):
        ...
        for div in divs:
            ...
            if self.isSimilarProductDiv(div) or self.isShareItem(div):
                self.reader.hideElement(div)
