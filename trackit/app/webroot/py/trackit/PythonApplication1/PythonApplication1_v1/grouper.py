...
#                break
    ...
    def XPathBuilder(self):
        ...
        tracker_info['title-xpath'] =  title_xpath
        tracker_info['price-xpath'] =  price_xpath
        tracker_info['old-price-xpath'] =  old_price_xpath
        tracker_info['product-img-xpath'] =  pimg_xpaths[0]
        tracker_info['product-img-xpath1'] =  pimg_xpaths[0]
        tracker_info['product-img-xpath2'] =  pimg_xpaths[1]
        tracker_info['product-img-xpath3'] =  pimg_xpaths[2]
        tracker_info['product-img-xpath4'] =  pimg_xpaths[3]
        tracker_info['product-img-xpath5'] =  pimg_xpaths[4]
        
        tracker_info['title_and_price-xpath'] =  xpath_of_title_and_price_parent_with_id
    ...
    def clean_outside_main_area(self, product_div):
        ...
        outer_ele = self.PLP.getOuterElementOfProduct(product_div)
        #self.PLP.hideElementsOutsideElement(outer_ele)
        self.PLP.hideElementsBelowElement(outer_ele)
    ...
    def clean_it(self):
        ...
        self.clean_outside_main_area(product_div)
        self.PLP.clean_distracting_divs()
...
#				text_price = textHasPrice(text)
    ...
    def FindPrice(self):
        ...
        for eid in eidmap:
            ...
            # price shouldnt be above product
            if y1 < y1p:
                continue
...
#			text = innerhtml #getWebElementText(self.alle[eid]) # this is most likely inner html
            ...
            if itIsOldPrice == False and (dist < mindist):
                price = text_price
                price_eid = eid
                mindist = dist
            elif itIsOldPrice == True and (dist < oldPrice_mindist):
        ...
        print "~~~~~~~~~~~~~~~~Price~~~~~~~~~~~~~~~~~~~"
        print {'price':self.price, 'dist': mindist}
        print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
        ...
        if self.price_eid and old_price_eid:
            ...
            if (old_price_y1 < price_y2 + price_height) and (old_price_y1 >= y1t):	# old price y is between (title_y1 and price_y2 + price_height)
                ...
                print "~~~~~~~~~~~~~~~~Old Price~~~~~~~~~~~~~~~~~~~"
                print {'price':self.old_price, 'dist': oldPrice_mindist}
                print "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
    ...
    def FindTitle(self):
        ...
        if len(full_title) > 0:
            ...
            for eid in eid_list_h_sorted:
                ...
                if self.tag_dict.isApparelType(cleaned_up_text) == 1:
        ...
        for eid in eid_list_h_sorted:
            ...
            if cleaned_up_text.count(' ') == 0 or len(element_words) < 2:
                continue
